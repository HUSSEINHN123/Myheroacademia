module.exports = {
  config: {
    name: "أولاد",
    author: "مجرد مجنون", // Convert To Goat By Tokodori
    role: 2,
    shortDescription: "يرسل لك صور أولاد صور فخمة 😎",
    longDescription: "",
    category: "متعة",
    guide: "{pn}"
  },

onStart: async({api,event,args,Users,Threads,Currencies}) => {
...
"https://i.imgur.com/aV4WVsq.jpg"
     ...
     var callback = () => api.sendMessage({body:`[ 🖼️ | إليك صور الفتيان 😎]`,attachment: fs.createReadStream(__dirname + "/cache/1.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.jpg"));  
