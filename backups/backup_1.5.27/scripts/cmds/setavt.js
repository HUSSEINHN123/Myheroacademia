...
module.exports = {
	config: {
		...
		shortDescription: {
			vi: "Đổi avatar bot",
			en: "قم بتغيير صورة بروفايل البوت"
		},
		longDescription: {
			vi: "Đổi avatar bot",
			en: "قم بتغيير صورة بروفايل البوت"
	...
	langs: {
		...
		en: {
			cannotGetImage: "❌ | حدث خطأ أثناء الاستعلام عن عنوان الرابط للصورة",
			invalidImageFormat: "❌ | تنسيق الصورة غير صالح",
			changedAvatar: "✅ | تم تغيير صورة البروفايل للبوت بنجاح"
		}
	},
