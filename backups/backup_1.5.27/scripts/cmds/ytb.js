...
module.exports = {
	config: {
		...
		longDescription: {
			...
			en: "قم بتنزيل الفيديوهات و الأغاني الصوتية من يوتيوب"
		},
		category: "وسائط",
		guide: {
			vi: "   {pn} [video|-v] [<tên video>|<link video>]: dùng để tải video từ youtube."
				...
				+ "\n    {pn} -a Fallen Kingdom"
				+ "\n    {pn} -i Fallen Kingdom",
			en: "   {pn} [مقطع| فيديو] [<إسم الفيديو>|<رابط الفيديو>]: إستخدمه لتحميل من يوتيوب."
				+ "\n   {pn} [أغنية|غني] [<إسم الأغنية>|<رابط الأغنية>]: تستخدم من أجل تحميل الأغاني من يوتيوب"
				+ "\n   {pn} [معلومات|-بيانات] [<إسم الفيديو>|<رابط الفيديو>]: يستخدم من أجل أن ترى معلومات حول فيديو من يوتيوب"
				+ "\n   مثال:"
				+ "\n    {pn} فيديو شارة القناص"
				+ "\n    {pn} غني شارة القناص"
				+ "\n    {pn} بيانات شارة القناص"
		}
	},
	...
	langs: {
		...
		en: {
			error: "❌ | حدث خطأ : %1",
			noResult: "⭕ لم يطابق النتائج ماأدخلته %1",
			choose: "%1قم بالرد على هذه الرسالة بالرقم لاختيار الفيديو أو أي حرف آخر لإلغاء",
			video: "فيديو",
			audio: "أغنية",
			downloading: "⬇️ جاري التحميل %1 \"%2\"",
			downloading2: "⬇️ جاري تحميل %1 \"%2\"\n🔃 السرعة: %3ميغابايت/s\n⏸️ تم التجميل : %4/%5 ميغابايت (%6%)\n⏳ الوقت المقدر المتبقي: %7 ثواني",
