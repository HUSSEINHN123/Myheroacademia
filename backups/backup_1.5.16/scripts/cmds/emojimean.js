...
module.exports = {
	config: {
		...
		shortDescription: {
			...
			en: "قم بالبحث عن المعنى لإيموجي ما"
		},
		longDescription: {
			vi: "Tìm nghĩa của emoji",
			en: "قم بالبحث عن معنى لإيموجي ما"
		},
		category: "خدمات",
		guide: {
			vi: "   {pn} <emoji>: Tìm nghĩa của emoji",
			en: "   {pn} <الإيموجي>: إبجث عن معنى للإيموجي"
		}
	},
	...
	langs: {
		...
		en: {
			missingEmoji: "⚠️ أنت لم تقم بإدخال أي إيموجي بعد",
			meaningOfEmoji: "📌 معنى الإيموجي  %1 :\n\n📄 المعنى الأول : %2\n\n📑 مزيد من التفاصيل : %3%4\n\n📄 الرمز القصير : %5\n\n©️ المصدر : %6\n\n📺 |فيما يلي صور للرموز التعبيرية المعروضة على بعض المنصات :",
			meaningOfWikipedia: "\n\n📝 قم بالتفاعل مع هذه الرشالة لمزيد من التفاصيل حول هذا الإيموجي ",
			meanOfWikipedia: "📑 معنى \"%1\" على ويكيبيديا :\n%2",
			manyRequest: "⚠️ لقد أرسل البوت عددًا كبيرًا جدًا من الطلبات، يرجى المحاولة مرة أخرى لاحقًا",
			notHave: " ❌ | لايوجد"
		}
	},
